...
import { CommentOnPost } from "../blog/post";
...
export const MsgCreatePost = {
    encode(message, writer = Writer.create()) {
        ...
        for (const v of message.comment) {
            CommentOnPost.encode(v, writer.uint32(42).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 5:
                    message.comment.push(CommentOnPost.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if (object.comment !== undefined && object.comment !== null) {
            for (const e of object.comment) {
                message.comment.push(CommentOnPost.fromJSON(e));
            }
        }
        return message;
    },
    toJSON(message) {
        ...
        message.body !== undefined && (obj.body = message.body);
        if (message.comment) {
            obj.comment = message.comment.map((e) => e ? CommentOnPost.toJSON(e) : undefined);
        }
        else {
            obj.comment = [];
        }
    ...
    fromPartial(object) {
        ...
        if (object.comment !== undefined && object.comment !== null) {
            for (const e of object.comment) {
                message.comment.push(CommentOnPost.fromPartial(e));
            }
        }
        return message;
    },
...
export class MsgClientImpl {
    ...
    UpdatePost(request) {
        ...
        const promise = this.rpc.request("example.blog.blog.Msg", "UpdatePost", data);
        return promise.then((data) => MsgUpdatePostResponse.decode(new Reader(data)));
    }
    DeletePost(request) {
        const data = MsgDeletePost.encode(request).finish();
        const promise = this.rpc.request("example.blog.blog.Msg", "DeletePost", data);
